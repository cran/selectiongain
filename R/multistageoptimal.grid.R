# mutistageoptimal.grid.R author: xuefei mi, 29-03-2013, for selectiongain package v2.0.2
...
# it is the hardest code, i have to optimize the loop part later.